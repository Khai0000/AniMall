...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    if (service) {
      setLoadedImageUrls(loadedImageUrls);
    }
  }, [service]);
  ...
  const updateServiceCommentsAndRating = (newComment, newRating) => {
    ...
    updatedService.serviceComments.push(newComment);
  ...
  return (
    <div className="serviceDetailsContainer">
      ...
      <div className="feedbackContainer">
        ...
        <div className="commentContainer">
          ...
          <div className="commentBody">
            {service.serviceComments && service.serviceComments.length === 0 ? (
      ...
      {showPopup && (
        <CommentPopUp setShowPopup={setShowPopup} serviceId={serviceId} serviceTitle={service.serviceTitle} updateServiceCommentsAndRating={updateServiceCommentsAndRating} />
      )}
    </div>
  );
