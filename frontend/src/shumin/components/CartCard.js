...
const CartCard = ({product})=>{
    ...
    const handleQuantityChange = (event) => {
        ...
        if (!isNaN(newQuantity) && newQuantity >= 0) {
            ...
            } else if ((product.type === "product" || product.type === "pet") && newQuantity > product.stockLevel) {
    ...
    return(
        ...
        <div>
            <div className="seller-product-card-container">
                <button className={`seller-product-card-checkbox${isChecked?"-clicked":"-unclicked"}`} onClick={handleCheckboxClick}>
                    {isChecked?
