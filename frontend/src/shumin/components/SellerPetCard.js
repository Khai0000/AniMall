...
const SellerPetCard = ({pet})=>{
    ...
    const initialQuantity = pet.stockLevel;
    ...
    return(
        ...
        <div>
            <div className="seller-product-card-container">
                <button className={`seller-product-card-checkbox${!isHidden?"-clicked":"-unclicked"}`} onClick={handleCheckboxClick}>
                    {!isHidden?
                ...
                <input type="number" className="seller-product-card-quantity-input" value={quantity} onChange={handleQuantityChange} onKeyPress={handleKeyPress} ></input>
                <button className="seller-product-card-plus-button" onClick={()=>setNewQuantity("plus")}>+</button>
                <h4 className="seller-product-card-price">{pet.price}</h4>
                <button className="seller-product-card-remove-button" onClick={handleOnRemoveClicked}>
