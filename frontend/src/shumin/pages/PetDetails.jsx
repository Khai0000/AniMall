            ...
            <div className="top-side-container">
                ...
                <div className="right-side">
                    ...
                    <div className="button-container">
                        <button className="add-to-cart-button" onClick={pet.price==0? handleOnAdoptButtonClick:handleOnAddToCartButtonClick}>
                            {pet.price ==0 ?
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <span className="add-to-cart-button-text">{pet.price ==0 ? "Adoption" : "Add to Cart"}</span>
                        </button>
                        <button onClick={handleNavigateBack} className="back-button">Back</button>
                    </div>
                </div>
            </div>
            <AdoptFormPopUp show={showForm} onClose={() => {setShowForm(false)} } whenSubmit={()=>{setShowForm(false);alert("Your form is submitted. Thank you for yourn kindness.");setShowAd(true);}} />{/* Passing props correctly */}
