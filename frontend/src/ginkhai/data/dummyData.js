...
export const dogData = [
  ...
  },
  {
    ...
    comments: [
      {
        name: "Sophie",
        content: "German Shepherds are incredibly loyal and intelligent dogs.",
      },
      {
        name: "Jack",
        content:
          "I've always admired the versatility of German Shepherds. They excel in so many roles!",
      },
      {
        name: "Emily",
        content:
          "German Shepherds make excellent working dogs. Rocky sounds like a true companion.",
      },
      {
        name: "Daniel",
        content:
          "I grew up with a German Shepherd. They're such loving and protective pets.",
      },
      {
        name: "Mia",
        content:
  ...
  },
  {
    ...
    comments: [
      {
        name: "Lily",
        content: "Golden Retrievers are such gentle and loving dogs.",
      },
      {
        name: "Owen",
        content:
          "I've always wanted a Golden Retriever. Bailey sounds like the perfect companion!",
      },
      {
        name: "Grace",
        content:
          "Bailey's story touched my heart. Golden Retrievers truly bring so much joy into our lives.",
      },
      {
        name: "Benjamin",
        content:
          "Golden Retrievers have the sweetest temperament. They're great with families!",
      },
      {
        name: "Zoe",
        content:
          "I've had the privilege of owning a Golden Retriever. They're the most loyal dogs.",
      },
      {
        name: "Elijah",
        content:
          "Bailey's loyalty and playful nature shine through in your story. Thanks for sharing!",
      },
      {
        name: "Natalie",
        content:
    ...
    comments: [
      {
        name: "Oliver",
        content:
          "Bulldogs have such a unique charm. Bruno sounds like a wonderful friend.",
      },
      {
        name: "Charlotte",
        content:
          "I've always been drawn to Bulldogs. They have such expressive faces!",
      },
      {
        name: "Henry",
        content:
...
export const catData = [
  {
    ...
    comments: [
      {
        name: "Ava",
        content: "Siamese cats have such striking features.",
      },
      {
        name: "Ethan",
        content:
          "Luna sounds like a wonderful companion. Siamese cats are known for their affectionate nature.",
      },
      {
        name: "Sophie",
        content:
          "I've always been fascinated by Siamese cats. They're so elegant!",
      },
      {
        name: "Michael",
        content:
  ...
  },
  {
    ...
    comments: [
      {
        name: "Liam",
        content: "Maine Coons are such majestic cats.",
      },
      {
        name: "Emma",
        content:
      ...
      {
        name: "Olivia",
        content: "Maine Coons have the most beautiful coats.",
      },
      {
        name: "Jack",
        content:
      ...
      {
        name: "James",
        content: "Maine Coons are one of the most beautiful cat breeds.",
      },
      {
        name: "Charlotte",
        content:
  ...
  },
  {
    ...
    comments: [
      {
        name: "Oliver",
        content: "Persian cats are so elegant and regal.",
      },
      {
        name: "Sophia",
        content:
      ...
      {
        name: "Elijah",
        content: "Persian cats are known for their luxurious fur.",
      },
      {
        name: "Grace",
        content:
      ...
      {
        name: "Mia",
        content: "Persian cats are such beautiful pets.",
      },
      {
        name: "Ethan",
        content:
      ...
      {
        name: "Liam",
        content: "Persian cats are known for their affectionate personalities.",
      },
      {
        name: "Charlotte",
        content:
      ...
      {
        name: "William",
        content: "Persian cats have such expressive faces.",
      },
      {
        name: "Emily",
        content:
      ...
      {
        name: "Isabella",
        content: "Persian cats are such wonderful companions.",
      },
      {
        name: "James",
        content:
      ...
      {
        name: "Ella",
        content: "Persian cats are so gentle and loving.",
      },
      {
        name: "Noah",
        content:
      ...
      {
        name: "Mia",
        content: "Persian cats are such gentle souls.",
      },
      {
        name: "Henry",
        content:
  ...
  },
  {
    ...
    comments: [
      {
        name: "Jackson",
        content: "Bengal cats are so energetic and playful.",
      },
      {
        name: "Sophia",
        content:
          "Leo sounds like such a fun and adventurous cat. Bengals are known for their wild spirit!",
      },
      {
        name: "Ethan",
        content: "Bengal cats have such beautiful markings.",
      },
      {
        name: "Ava",
        content:
          "I've always admired Bengal cats. Leo sounds like a true character!",
      },
      {
        name: "Lily",
