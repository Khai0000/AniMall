        ...
        <div className='register-pages-container'>
            ...
            {!showVerify ? (
                <div className='register-pages'>
                    <div className='register-component'>
                        ...
                        <form className='register-container'>
                            ...
                            <button className='register-button' onClick={handleRegisterClick} type="button">REGISTER</button>
                        </form>
                    </div>
                </div>
            ) : (
                <div className='register-verify'>
                    ...
                    <p className='re-send'>
                        Didn't receive it ? <button className='resend-button' onClick={handleResendClick} type='button'>Send Again</button>
                    </p>
                </div>
            )}
        </div>
